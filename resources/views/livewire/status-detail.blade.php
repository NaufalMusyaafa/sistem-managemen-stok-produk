<div>
    ...
    {{-- ============================================================ --}}
    {{-- Content — fully owned by Livewire, zero Alpine interference  --}}
    {{-- ============================================================ --}}
    <div class="py-8">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($items as $index => $item)
                                ...
                                <tr
                                    ...
                                    @if ($isClickable)
                                        onclick="window.dispatchEvent(new CustomEvent('open-item-modal', {detail: @js([
                                            'id'             => $item->id,
                                            ...
                                            'rop'            => (int) $rop,
                                            'procurementUrl' => route('procurement.create', ['id' => $item->id]) . '?from=' . $type,
                                            'warehouseUrl'   => route('warehouse.detail', $item->warehouse_id),
                                        ])}))"
                                    @endif
                                >
    ...
    {{-- ============================================================ --}}
    {{-- Item Action Modal — isolated Alpine scope, event-driven      --}}
    {{-- ============================================================ --}}
    <div
        x-data="{
            showModal: false,
        ...
        @open-item-modal.window="showModal = true; selectedItem = $event.detail"
